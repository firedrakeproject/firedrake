...
template<> const long double Math<long double>::ZERO_TOLERANCE = 1e-14;
...
template<> const long double Math<long double>::LN_2 = Math<long double>::Log(2.0);
template<> const long double Math<long double>::LN_10 = Math<long double>::Log(10.0);
template<> const long double Math<long double>::INV_LN_2 = 1.0/Math<long double>::LN_2;
template<> const long double Math<long double>::INV_LN_10 = 1.0/Math<long double>::LN_10;
//----------------------------------------------------------------------------
template <>
