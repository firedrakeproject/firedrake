...
subroutine test_pickers
  ...
  positions = read_triangle_files("data/triangle.1", quad_degree = 1)
  ...
  call picker_inquire(positions, (/-1.0, 0.0/), ele)
  ...
  call picker_inquire(positions, (/0.25, 0.0/), ele)
  call report_test("[Point contained]", ele /= 1, .false., "Reported incorrect containing element")

  call deallocate(positions)

  call report_test_no_references()

end subroutine test_pickers
