...
!    USA
subroutine test_vector_lon_lat_height_2_cartesian_c
  ...
  call report_test( &
   "[Vector basis change: Zonal-Meridional-Vertical to Cartesian of unit-radial vector (C-types).]", &
  ...
  call report_test( &
   "[Vector basis change: Zonal-Meridional-Vertical to Cartesian of unit-polar vector (C-types).]", &
  ...
  call report_test( &
   "[Vector basis change: Zonal-Meridional-Vertical to Cartesian of unit-azimuthal vector (C-types).]", &
