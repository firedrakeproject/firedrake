...
node('firedrake-build') {
  ...
  env.FIREDRAKE_INSTALL_FLAGS = "--minimal-petsc --disable-ssh";
  ...
  sh 'docker build --build-arg FIREDRAKE_INSTALL_FLAGS=\$FIREDRAKE_INSTALL_FLAGS tmbgreaves/firedrakebuilds:$BUILD_ID .';
