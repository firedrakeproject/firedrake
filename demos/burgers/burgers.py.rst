...
option is to let the :class:`VTKFile <firedrake.vtk_output.VTKFile>` object manage the
...
:class:`VTKFile <firedrake.vtk_output.VTKFile>`). Outputting data is carried out using
the :meth:`write <firedrake.vtk_output.VTKFile.write>` method of
:class:`VTKFile <firedrake.vtk_output.VTKFile>` objects::
