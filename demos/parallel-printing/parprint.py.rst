...
`PETSc object types <https://petsc.org/release/petsc4py/reference/petsc4py.PETSc.html>`_,
including types like `Vec <https://petsc.org/release/petsc4py/reference/petsc4py.PETSc.Vec.html>`_::
