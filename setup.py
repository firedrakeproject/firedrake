...
setup(name='firedrake',
      ...
      ext_modules=[Extension('firedrake.dmplex',
                   ...
                   Extension('firedrake.spatialindex',
                             ...
                             library_dirs=["/home/fl1612/Packages/spatialindex-src-1.8.5/build/lib"],
                             include_dirs=[np.get_include(), "/home/fl1612/Packages/spatialindex-src-1.8.5/build/include"],
