...
<https://nbviewer.jupyter.org/github/firedrakeproject/firedrake/blob/master/docs/notebooks/example-spd-helmholtz.ipynb>`__.
...
them
<https://nbviewer.jupyter.org/github/firedrakeproject/firedrake/blob/master/docs/notebooks/example-poisson.ipynb>`__.
...
<https://nbviewer.jupyter.org/github/firedrakeproject/firedrake/blob/master/docs/notebooks/example-elasticity.ipynb>`__.
...
<https://nbviewer.jupyter.org/github/firedrakeproject/firedrake/blob/master/docs/notebooks/example-burgers.ipynb>`__.

A mixed formulation of the Poisson equation
===========================================

`In this notebook
<https://nbviewer.jupyter.org/github/firedrakeproject/firedrake/blob/master/docs/notebooks/example-mixed-poisson.ipynb>`__.,
...
<https://nbviewer.jupyter.org/github/firedrakeproject/firedrake/blob/master/docs/notebooks/example-stokes-bc-control.ipynb>`__
...
<https://nbviewer.jupyter.org/github/firedrakeproject/firedrake/blob/master/docs/notebooks/example-multigrid.ipynb>`__.
