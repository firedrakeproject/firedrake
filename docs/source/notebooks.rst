...
<https://nbviewer.jupyter.org/github/firedrakeproject/firedrake/blob/main/docs/notebooks/01-spd-helmholtz.ipynb>`__
...
them
<https://nbviewer.jupyter.org/github/firedrakeproject/firedrake/blob/main/docs/notebooks/02-poisson.ipynb>`__.
...
linear solvers
<https://nbviewer.jupyter.org/github/firedrakeproject/firedrake/blob/main/docs/notebooks/03-elasticity.ipynb>`__.
...
<https://nbviewer.jupyter.org/github/firedrakeproject/firedrake/blob/main/docs/notebooks/04-burgers.ipynb>`__.
You can run this notebook yourself `on Colab
...
`In this notebook
<https://nbviewer.jupyter.org/github/firedrakeproject/firedrake/blob/main/docs/notebooks/05-mixed-poisson.ipynb>`__.,
...
<https://nbviewer.jupyter.org/github/firedrakeproject/firedrake/blob/main/docs/notebooks/06-pde-constrained-optimisation.ipynb>`__
...
<https://nbviewer.jupyter.org/github/firedrakeproject/firedrake/blob/main/docs/notebooks/07-geometric-multigrid.ipynb>`__.
You can run this notebook yourself `on Colab
...
particular problem
<https://nbviewer.jupyter.org/github/firedrakeproject/firedrake/blob/main/docs/notebooks/08-composable-solvers.ipynb>`__.
You can run this notebook yourself `on Colab
...
hybridisation
<https://nbviewer.jupyter.org/github/firedrakeproject/firedrake/blob/main/docs/notebooks/09-hybridisation.ipynb>`__.
You can run this notebook yourself `on Colab
...
<https://nbviewer.jupyter.org/github/firedrakeproject/firedrake/blob/main/docs/notebooks/10-sum-factorisation.ipynb>`__.
You can run this notebook yourself `on Colab
...
<https://nbviewer.jupyter.org/github/firedrakeproject/firedrake/blob/main/docs/notebooks/11-extract-adjoint-solutions.ipynb>`__.
You can run this notebook yourself `on Colab
...
<https://nbviewer.jupyter.org/github/firedrakeproject/firedrake/blob/main/docs/notebooks/12-HPC_demo.ipynb>`__
