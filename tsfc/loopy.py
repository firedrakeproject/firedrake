...
def statement_return(leaf, ctx):
    ...
    # NOTE: I disabled this because it seems like it is not sufficient in all cases
    # and we need to zero WRITE kernels on the way in. If that works then this code can go.
    # #
    ...
    #         lp.CInstruction((), "printf(\"hi there\\n\");", within_inames=ctx.active_inames())
    #     )
