...
from firedrake.petsc import DEFAULT_PARTITIONER, PETSc
from firedrake.utils import IntType, RealType, as_cstr
from pyop2 import op2
from pyop2.mpi import COMM_WORLD, MPI, temp_internal_comm
...
values from f.)"""
    ...
    def bounding_box_coords(self) -> Tuple[np.ndarray, np.ndarray] | None:
        ...
        from firedrake.parloops import MAX, MIN, READ, par_loop
...
class MeshSequenceGeometry(ufl.MeshSequence):
    ...
    def set_hierarchy(self):
        ...
        from firedrake.mg.utils import get_level, has_level, set_level
