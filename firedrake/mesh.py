...
values from f.)"""
    ...
    def curve_field(self, order, permutation_tol=None, cg_field=None):
        ...
        :arg permutation_tol: deprecated and ignored as an input; the permutation
            tolerance is now selected automatically from precision (1e-5 in single
            precision, 1e-8 in double, since 1e-8 is below float32 resolution).
