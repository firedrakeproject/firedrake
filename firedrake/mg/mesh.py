...
__all__ = ("HierarchyBase", "MeshHierarchy", "BaryMeshHierarchy", "ExtrudedMeshHierarchy", "NonNestedHierarchy",
...
def BaryMeshHierarchy(mesh, refinement_levels, distribution_parameters=None, callbacks=None, reorder=None,
    ...
    for (coarseu, fineu), (coarse, fine), (clgmaps, flgmaps), uniform_coarse_to_fine \
        ...
        plex_uniform_coarse_to_fine = np.empty_like(uniform_coarse_to_fine)
        ...
        plex_coarse_bary_to_fine_bary = np.full((ncoarse*(d+1),
        ...
        coarse_bary_to_fine_bary = np.empty_like(plex_coarse_bary_to_fine_bary)
        ...
        for i in range(np.max(coarse_bary_to_fine_bary)):
        ...
        fine_bary_to_coarse_bary = np.asarray(fine_bary_to_coarse_bary, dtype=PETSc.IntType)
