...
def MeshHierarchy(mesh, refinement_levels,
    ...
    for i in range(refinement_levels*refinements_per_level):
        # Refine an unoverlapped plex at each level.
        cdm = make_unoverlapped_dm(cmesh.topology_dm)
        ...
        flgmaps = (
            ...
            impl.create_lgmap(fmesh_orig.topology_dm),
        )

        c2f, f2c = impl.coarse_to_fine_cells(cmesh, fmesh_orig,
                                             clgmaps, flgmaps)
