...
def tsfc_compile_form_hashkey(form, prefix, parameters, dont_split_numbers, diagonal, log):
    # Drop prefix as it's only used for naming and log
    return default_parallel_hashkey(form.signature(), prefix, parameters, dont_split_numbers, diagonal)
