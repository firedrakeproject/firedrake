...
def generate_loopy_kernel(slate_expr, compiler_parameters=None):
    ...
    (slate_loopy, slate_loopy_event), output_arg = gem_to_loopy(gem_expr, var2terminal, scalar_type, "slate_loopy",
    ...
    loopy_merged, arguments, events = merge_loopy(slate_loopy, output_arg, builder, var2terminal,
