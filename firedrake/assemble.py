...
def matrix_arg(access, get_map, row, col, domain_type, *,
    ...
    if row is None and col is None:
        ...
        lgmaps, unroll = collect_lgmaps(matrix, all_bcs,
                                        Vrow, Vcol, row, col)
        return matrix.M[row, col](access, maps, lgmaps=(lgmaps, ),
                                  unroll_map=unroll)
...
def vector_arg(access, get_map, i, *, function=None, V=None):
    ...
    if i is None:
        ...
        if map_:
            ...
            pass
        return function.dat[i](access, map_ if map_ else None)
