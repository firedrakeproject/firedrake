...
from firedrake.ufl_expr import extract_unique_domain, extract_domains
        ...
        if self._allocation_integral_types is not None:
            ...
            for assembler in self._all_assemblers:
                for local_kernel, subdomain_id in assembler.local_kernels:
                    ...
                    all_subdomain_ids = assembler.all_integer_subdomain_ids[local_kernel.kinfo.domain_number]
    ...
    def _all_assemblers(self):
        ...
        for bc in self._bcs:
            if isinstance(bc, EquationBCSplit):
                all_assemblers.append(type(self)(bc.f, bcs=bc.bcs, form_compiler_parameters=self._form_compiler_params, needs_zeroing=False))
