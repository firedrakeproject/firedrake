...
# The SHA of the Firedrake commit to be built
ARG FIREDRAKE_INSTALL_SHA='HEAD'
...
RUN $FIREDRAKE_HOME/firedrake-install --package-branch firedrake $FIREDRAKE_INSTALL_SHA $FIREDRAKE_INSTALL_FLAGS || $FIREDRAKE_HOME/firedrake-install --package-branch firedrake $FIREDRAKE_INSTALL_SHA $FIREDRAKE_INSTALL_FLAGS
