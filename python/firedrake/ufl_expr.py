...
def adjoint(form, reordered_arguments=None):
    ...
    # ufl.adjoint creates new Arguments if no reordered_arguments is given.
    # To avoid that, always pass reordered_arguments with firedrake.Argument objects. 
    if reordered_arguments is None:
        v, u = extract_arguments(form)
        reordered_arguments = (Argument(u.element(), u.function_space()), Argument(v.element(), v.function_space()))
