...
@pytest.fixture
def cache_key(mass):
    return tsfc_interface.TSFCKernel(mass, 'mass', parameters["form_compiler"], {}, {0: 0}, None).cache_key
...
u = TrialFunction(V)
v = TestFunction(V)
key = tsfc_interface.TSFCKernel(u*v*dx, "mass", parameters["form_compiler"], {{}}, {{0: 0}}, None).cache_key
