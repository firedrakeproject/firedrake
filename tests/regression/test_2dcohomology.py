...
def test_betti0(space, mesh):
    ...
    bc0 = DirichletBC(V0, Constant(0.0, domain=mesh), 9)
...
def test_betti1(space, mesh):
    ...
    bc0 = DirichletBC(W.sub(0), Constant(0.0, domain=mesh), 9)
    bc1 = DirichletBC(W.sub(1), Constant((0.0, 0.0), domain=mesh), 9)
...
def test_betti2(space, mesh):
    ...
    bc1 = DirichletBC(W.sub(0), Constant((0.0, 0.0), domain=mesh), 9)
