...
@pytest.fixture(scope="module",
                params=[("mu_s*inner(outer(v, n), grad(u))*ds",
                         "mu_s*inner(outer(v, n), grad(u))*ds"),
                        ("mu_s*(-inner(outer(v, n), grad(u)) - inner(outer(u, n), grad(v)))*ds",
                         "-2*mu_s*(inner(outer(v, n), grad(u)))*ds"),
                        ("-mu_s*(inner(outer(v, n), grad(u)) + inner(outer(u, n), grad(v)))*ds",
                         "-2*mu_s*(inner(outer(v, n), grad(u)))*ds"),
                        ("inner(outer(v, n), dot(grad(u), mu))*ds",
                         "mu_s*inner(outer(v, n), grad(u))*ds"),
