...
def _test_submesh_assemble_quad_triangle_base():
    dim = 2
    label_ext = 1
    label_interf = 2
...
def test_submesh_assemble_quad_triangle_base_one_process():
    _test_submesh_assemble_quad_triangle_base()


@pytest.mark.parallel(nprocs=2)
def test_submesh_assemble_quad_triangle_base_two_processes():
    _test_submesh_assemble_quad_triangle_base()


@pytest.mark.parallel(nprocs=3)
def test_submesh_assemble_quad_triangle_base_three_processes():
    _test_submesh_assemble_quad_triangle_base()
