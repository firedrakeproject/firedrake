...
def _control_bvs(controls: Iterable[Any] | None = None) -> set[Any]:
    """Return the block variables that represent the controls."""
    if controls is None:
        return set()
    return {control.block_variable for control in controls}
