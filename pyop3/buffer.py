...
class NullBuffer(AbstractArrayBuffer):
    ...
    def get_disk_cache_key(self, visitor) -> Hashable:
        return (type(self), self._shape, visitor.renamer.add_obj(self), self._dtype)
...
class PetscMatBuffer(ConcreteBuffer):
    ...
    @property
    def insert_mode(self) -> PETSc.InsertMode:
        _, mode = self._mat
        return mode

    @insert_mode.setter
    def insert_mode(self, new_insert_mode: PETSc.InsertMode, /) -> None:
        mat, _ = self._mat
        self._mat = (mat, new_insert_mode)
